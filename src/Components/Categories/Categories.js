        ...
        <div className="row">
            ...
            {categoryList.map((category,i)=>(
                 ...
                 <div className="shadow menu-item-card p-3 mb-3" >
                     <img src={category.image} alt="birthday" className="menu-item-image w-100" />
                     <h1 className="menu-card-title">{category.title}</h1>
                    <p style={{color:"#fa4f34"}} ><i class="fas fa-rupee-sign"></i>{category.price}</p>
