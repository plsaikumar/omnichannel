        ...
        <div className="row">
            ...
            <div className="col-12 col-md-6 col-lg-3">
                <div className="menu-item-card shadow p-3 mb-3">
                    <img src="https://oyehappy.sgp1.digitaloceanspaces.com/wp-content/uploads/2020/01/IMG_8587.jpg" className="menu-item-image w-100" />
            ...
            <div className="col-12 col-md-6 col-lg-3">
                <div className="menu-item-card shadow p-3 mb-3">
                    <img src="https://oyehappy.sgp1.digitaloceanspaces.com/wp-content/uploads/2019/10/IMG_0926.jpg" className="menu-item-image w-100" />
            ...
            <div className="col-12 col-md-6 col-lg-3">
                <div className="menu-item-card shadow p-3 mb-3">
                    <img src="https://oyehappy.sgp1.digitaloceanspaces.com/wp-content/uploads/2019/12/Tb-min-5.jpg" className="menu-item-image w-100" />
            ...
            <div className="col-12 col-md-6 col-lg-3">
                <div className="menu-item-card shadow p-3 mb-3">
                    <img src="https://oyehappy.sgp1.digitaloceanspaces.com/wp-content/uploads/2020/06/optimized-7hpr-1.jpg" className="menu-item-image w-100" />
            ...
            <div className="col-12 col-md-6 col-lg-3">
                <div className="menu-item-card shadow p-3 mb-3">
                    <img src="https://oyehappy.sgp1.digitaloceanspaces.com/wp-content/uploads/2019/10/IMG_5625.jpg" className="menu-item-image w-100" />
            ...
            <div className="col-12 col-md-6 col-lg-3">
                <div className="menu-item-card shadow p-3 mb-3">
                    <img src="https://oyehappy.sgp1.digitaloceanspaces.com/wp-content/uploads/2020/01/Untitled-design-40-3.jpg" className="menu-item-image w-100" />
            ...
            <div className="col-12 col-md-6 col-lg-3">
                <div className="shadow menu-item-card p-3 mb-3">
                    <img src="https://oyehappy.sgp1.digitaloceanspaces.com/wp-content/uploads/2017/07/2-1.jpg" className="menu-item-image w-100" />
